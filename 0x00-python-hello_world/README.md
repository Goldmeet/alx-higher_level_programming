...
An Informal Introduction to Python (Read up 3.1.2.  included)
How To Use String Formatters in Python 3
Learn to Program
Pycodestyle StLearning Objectives
...
Namespaces are one honking great idea -- let's do more of those!DonwondonelsePythonname ringsuntil Authornutshell
